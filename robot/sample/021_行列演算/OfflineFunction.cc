...
// プロトタイプ宣言
void ArcsMatTest(void);		//!< ArcsMatクラスのテストコード
...
//! @brief ArcsMatクラスのテストコード
void ArcsMatTest(void){
	printf("ArcsMatクラスのテスト:\n");
...
void ArcsVarMatTest(void){
	printf("ArcsVarMatクラスのテスト:\n");
