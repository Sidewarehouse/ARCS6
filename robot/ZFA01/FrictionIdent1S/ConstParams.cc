...
const std::string ConstParams::CTRLNAME("<TITLE: ZFA01 FRICTION IDENTIFICATION 1S>");		//!< (画面に入る文字数以内)

// ARCS改訂番号(ARCS本体側システムコード改変時にちゃんと変えること)
const std::string ConstParams::ARCS_REVISION("REV.ZFA121100116");	//!< (16文字以内)
