...
const std::string ConstParams::CTRLNAME("<TITLE: ZFA01 FORCE SENSOR TEST >");		//!< (画面に入る文字数以内)

// ARCS改訂番号(ARCS本体側システムコード改変時にちゃんと変えること)
const std::string ConstParams::ARCS_REVISION("REV.ZFA121090915");	//!< (16文字以内)
...
> ConstParams::PLOT_VAR_NAMES = {{
	...
	{"X", "Y", "Z", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},		// プロット4
