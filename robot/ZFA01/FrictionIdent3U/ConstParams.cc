...
const std::string ConstParams::CTRLNAME("<TITLE: ZFA01 FRICTION IDENTIFICATION 3U>");		//!< (画面に入る文字数以内)

// ARCS改訂番号(ARCS本体側システムコード改変時にちゃんと変えること)
const std::string ConstParams::ARCS_REVISION("REV.ZFA121121616");	//!< (16文字以内)
