...
namespace ARCS {	// ARCS名前空間
	...
	class ConstParams {
		public:
			...
			static constexpr double DATA_END   = 20;		//!< [s] 保存終了時刻
			...
			static constexpr unsigned int THREAD_NUM = 2;	//!< 動作させるスレッドの数 (最大数は THREAD_NUM_MAX 個まで)
			...
			static constexpr size_t PLOT_NUM =  6;						//!< [-] グラフプロットの数
