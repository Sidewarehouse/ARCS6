...
const std::string ConstParams::CTRLNAME("<TITLE: ZFA01 FORCE/POSITION HYBRID CONTROL>");		//!< (画面に入る文字数以内)

// ARCS改訂番号(ARCS本体側システムコード改変時にちゃんと変えること)
const std::string ConstParams::ARCS_REVISION("REV.ZFA122012710");	//!< (16文字以内)
...
const std::array<std::string, ConstParams::PLOT_MAX> ConstParams::PLOT_FLABEL = {
	...
	"WORKSPACE VELOCITY [m/s]",	// プロット4
	"WORKSPACE FORCE [N]",		// プロット5
	"---------- [-]",	// プロット6
	"---------- [-]",	// プロット7
	"---------- [-]",	// プロット8
	"---------- [-]",	// プロット9
