...
class ConstParams {
	public:
		...
		static constexpr char CTRLNAME[] = "<TITLE: ZFA01 CURRENT CONROL >";	//!< (画面に入る文字数以内)
		...
		static constexpr std::array<char[31], ARCSparams::PLOT_MAX> PLOT_FLABEL = {
			"CURRENT REF [A]",			// グラフプロット0
			"POSITION [rad]",			// グラフプロット1
			"VELOCITY [rad/s]",			// グラフプロット2
			"TORSION TORQUE [Nm]",		// グラフプロット3
			"WORKSPACE VELOCITY [m/s]",	// グラフプロット4
			"WORKSPACE FORCE [N]",		// グラフプロット5
			"---------- [-]",	// グラフプロット6
			"---------- [-]",	// グラフプロット7
			"---------- [-]",	// グラフプロット8
			"---------- [-]",	// グラフプロット9
		...
		> PLOT_VAR_NAMES = {{
			{"1S", "2L", "3U", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット0
			{"1S", "2L", "3U", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット1
			{"1S", "2L", "3U", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット2
			{"1S", "2L", "3U", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット3
			{"vx", "vy", "vz", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット4
			{"fx", "fy", "fz", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット5
		...
		static constexpr size_t PLOTXY_XGRID = 6;		//!< X軸グリッドの分割数
		static constexpr size_t PLOTXY_YGRID = 6;		//!< Y軸グリッドの分割数
		...
		static constexpr size_t PLOTXZ_XGRID = 6;		//!< X軸グリッドの分割数
		static constexpr size_t PLOTXZ_ZGRID = 6;		//!< Z軸グリッドの分割数
