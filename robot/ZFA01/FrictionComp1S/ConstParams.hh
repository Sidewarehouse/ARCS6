...
namespace ARCS {	// ARCS名前空間
	...
	class ConstParams {
		public:
			...
			static constexpr double DATA_END   = 128;		//!< [s] 保存終了時刻
			static constexpr double DATA_RESO  = 0.0001;	//!< [s] データの時間分解能
			static constexpr unsigned int DATA_NUM  =  3;	//!< [-] 保存する変数の数
			...
			static constexpr unsigned int ACTUATOR_NUM = ZFA01::N_AX;	//!< 実験装置のアクチュエータの総数
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_FORCE_TORQUE_CONST = {
				ZFA01::TORQUE_CONST1S,	// [N/A]/[Nm/A]  1番 アクチュエータ
				ZFA01::TORQUE_CONST2L,	// [N/A]/[Nm/A]  2番 アクチュエータ
				ZFA01::TORQUE_CONST3U,	// [N/A]/[Nm/A]  3番 アクチュエータ
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_RATED_CURRENT = {
				ZFA01::CURRENT_RATED1S,	// [A]  1番 アクチュエータ
				ZFA01::CURRENT_RATED2L,	// [A]  2番 アクチュエータ
				ZFA01::CURRENT_RATED3U,	// [A]  3番 アクチュエータ
				1,	// [A]  4番 アクチュエータ
				1,	// [A]  5番 アクチュエータ
				1,	// [A]  6番 アクチュエータ
				1,	// [A]  7番 アクチュエータ
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_MAX_CURRENT = {
				ZFA01::CURRENT_MAX1S,	// [A]  1番 アクチュエータ
				ZFA01::CURRENT_MAX2L,	// [A]  2番 アクチュエータ
				ZFA01::CURRENT_MAX3U,	// [A]  3番 アクチュエータ
				3,	// [A]  4番 アクチュエータ
				3,	// [A]  5番 アクチュエータ
				3,	// [A]  6番 アクチュエータ
				3,	// [A]  7番 アクチュエータ
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_RATED_TORQUE = {
				ZFA01::TORQUE_RATED1S,	// [Nm]  1番 アクチュエータ
				ZFA01::TORQUE_RATED2L,	// [Nm]  2番 アクチュエータ
				ZFA01::TORQUE_RATED3U,	// [Nm]  3番 アクチュエータ
				1,	// [Nm]  4番 アクチュエータ
				1,	// [Nm]  5番 アクチュエータ
				1,	// [Nm]  6番 アクチュエータ
				1,	// [Nm]  7番 アクチュエータ
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_MAX_TORQUE = {
				ZFA01::TORQUE_MAX1S,	// [Nm]  1番 アクチュエータ
				ZFA01::TORQUE_MAX2L,	// [Nm]  2番 アクチュエータ
				ZFA01::TORQUE_MAX3U,	// [Nm]  3番 アクチュエータ
				3,	// [Nm]  4番 アクチュエータ
				3,	// [Nm]  5番 アクチュエータ
				3,	// [Nm]  6番 アクチュエータ
				3,	// [Nm]  7番 アクチュエータ
			...
			static constexpr std::array<double, ACTUATOR_MAX> ACT_INITPOS = {
				ZFA01::POSITION_INIT1S,	// [rad]  1軸 アクチュエータ
				ZFA01::POSITION_INIT2L,	// [rad]  2軸 アクチュエータ
				ZFA01::POSITION_INIT3U,	// [rad]  3軸 アクチュエータ
				0,	// [rad]  4軸 アクチュエータ
			    0,	// [rad]  5軸 アクチュエータ
				0,	// [rad]  6軸 アクチュエータ 
				0,	// [rad]  7番 アクチュエータ
			...
			static constexpr size_t PLOT_NUM =  5;						//!< [-] グラフプロットの数
			...
			//! @brief 作業空間XYプロットの設定
			static constexpr bool PLOTXY_VISIBLE = true;	//!< プロット可視/不可視設定
			static constexpr int PLOTXY_LEFT = 1015;		//!< [px] 左位置
			static constexpr int PLOTXY_TOP = 97;			//!< [px] 上位置
			static constexpr int PLOTXY_WIDTH = 485;		//!< [px] 幅
			static constexpr int PLOTXY_HEIGHT = 455;		//!< [px] 高さ
			static const std::string PLOTXY_XLABEL;			//!< X軸ラベル
			static const std::string PLOTXY_YLABEL;			//!< Y軸ラベル
			static constexpr double PLOTXY_XMAX =  1.0;		//!< [m] X軸最大値
			static constexpr double PLOTXY_XMIN = -0.2;		//!< [m] X軸最小値
			static constexpr double PLOTXY_YMAX =  0.6;		//!< [m] Y軸最大値
			static constexpr double PLOTXY_YMIN = -0.6;		//!< [m] Y軸最小値
			static constexpr unsigned int PLOTXY_XGRID = 6;	//!< X軸グリッドの分割数
			static constexpr unsigned int PLOTXY_YGRID = 6;	//!< Y軸グリッドの分割数
			static constexpr double PLOTXY_VAL_XPOS =  0.7;	//!< 数値表示の左位置
			static constexpr double PLOTXY_VAL_YPOS =  0.55;//!< 数値表示の上位置
			
			//! @brief 作業空間XZプロットの設定
			static constexpr bool PLOTXZ_VISIBLE = true;	//!< プロット可視/不可視設定
			static constexpr int PLOTXZ_LEFT = 1015;		//!< [px] 左位置
			static constexpr int PLOTXZ_TOP = 556;			//!< [px] 上位置
			static constexpr int PLOTXZ_WIDTH = 485;		//!< [px] 幅
			static constexpr int PLOTXZ_HEIGHT = 455;		//!< [px] 高さ
			static const std::string PLOTXZ_XLABEL;			//!< X軸ラベル
			static const std::string PLOTXZ_ZLABEL;			//!< Z軸ラベル
			static constexpr double PLOTXZ_XMAX =  1.0;		//!< [m] X軸最大値
			static constexpr double PLOTXZ_XMIN = -0.2;		//!< [m] X軸最小値
			static constexpr double PLOTXZ_ZMAX =  1.2;		//!< [m] Z軸最大値
			static constexpr double PLOTXZ_ZMIN =  0.0;		//!< [m] Z軸最小値
			static constexpr unsigned int PLOTXZ_XGRID = 6;	//!< X軸グリッドの分割数
			static constexpr unsigned int PLOTXZ_ZGRID = 6;	//!< Z軸グリッドの分割数
			static constexpr double PLOTXZ_VAL_XPOS =  0.7;	//!< 数値表示の左位置
			static constexpr double PLOTXZ_VAL_ZPOS =  1.15;//!< 数値表示の上位置
